...
function get_base_url($botToken, $proxy = true)
{
    $main_url = "https://api.telegram.org/bot" . $botToken;

    return $proxy ? "https://basic-proxy.drb1367.workers.dev/proxy?proxyUrl=" . $main_url : $main_url;
}
